# Defaults for standard Node.exports builds
...
function(find_path_parent NAME BASE PATH)
    ...
    while(NOT ROOT MATCHES ${DRIVE} AND NOT ROOT STREQUAL "" AND NOT EXISTS ${ROOT}/${NAME})
        get_filename_component(ROOT ${ROOT} DIRECTORY)
        set(${PATH} ${ROOT}/${NAME} PARENT_SCOPE)
    endwhile()

    if(ROOT MATCHES ${DRIVE} OR ROOT STREQUAL "")
...
# Sets up a project to build Node.exports native modules
...
function(nodejs_init)
    ...
    # Now that its fully resolved, report the name and version of Node.exports being
    # used
