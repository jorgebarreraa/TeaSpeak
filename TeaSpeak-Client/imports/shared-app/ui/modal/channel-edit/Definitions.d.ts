...
export declare type ChannelEditablePermissions = "join" | "view" | "view-description" | "subscribe" | "modify" | "delete" | "browse" | "upload" | "download" | "rename" | "directory-create" | "file-delete";
export declare type ChannelEditablePermissionValue = {
    state: "editable" | "readonly" | "applying";
    value: number;
} | {
    state: "loading" | "unsupported";
};
export declare type ChannelEditPermissionsState = {
...
export declare type ChannelEditPropertyEvent<T extends keyof ChannelEditableProperty> = {
    property: T;
    value: ChannelEditableProperty[T];
};
export declare type ChannelEditPermissionEvent<T extends keyof ChannelPropertyPermission> = {
    permission: T;
